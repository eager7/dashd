...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/eager7/dashd/peer)
...
```bash
$ go get -u github.com/eager7/dashd/peer
```

## Examples

* [New Outbound Peer Example](https://godoc.org/github.com/eager7/dashd/peer#example-package--NewOutboundPeer)  
