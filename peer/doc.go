...
function which allows a dashlog.Logger to be specified.  For example, logging at
...
(https://godoc.org/github.com/eager7/dashd/wire#hdr-Bitcoin_Improvement_Proposals)
*/
package peer
