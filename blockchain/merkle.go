...
// is the zeroHash.
func BuildMerkleTreeStore(transactions []*dashutil.Tx, witness bool) []*chainhash.Hash {
...
func ExtractWitnessCommitment(tx *dashutil.Tx) ([]byte, bool) {
...
func ValidateWitnessCommitment(blk *dashutil.Block) error {
