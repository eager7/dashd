...
func (view *UtxoViewpoint) AddTxOut(tx *dashutil.Tx, txOutIdx uint32, blockHeight int32) {
...
func (view *UtxoViewpoint) AddTxOuts(tx *dashutil.Tx, blockHeight int32) {
...
func (view *UtxoViewpoint) connectTransaction(tx *dashutil.Tx, blockHeight int32, stxos *[]SpentTxOut) error {
...
func (view *UtxoViewpoint) connectTransactions(block *dashutil.Block, stxos *[]SpentTxOut) error {
...
func (view *UtxoViewpoint) disconnectTransactions(db database.DB, block *dashutil.Block, stxos []SpentTxOut) error {
...
// not modified.
func (view *UtxoViewpoint) fetchInputUtxos(db database.DB, block *dashutil.Block) error {
...
func (b *BlockChain) FetchUtxoView(tx *dashutil.Tx) (*UtxoViewpoint, error) {
