...
func GetBlockWeight(blk *dashutil.Block) int64 {
...
func GetTransactionWeight(tx *dashutil.Tx) int64 {
	msgTx := tx.MsgTx()
...
func GetSigOpCost(tx *dashutil.Tx, isCoinBaseTx bool, utxoView *UtxoViewpoint, bip16, segWit bool) (int, error) {
