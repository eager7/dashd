...
import (
	...
	peerpkg "github.com/eager7/dashd/peer"
...
func (sm *SyncManager) handleBlockchainNotification(notification *blockchain.Notification) {
	...
	case blockchain.NTBlockAccepted:
		...
		block, ok := notification.Data.(*dashutil.Block)
		if !ok {
...
// processed.
func (sm *SyncManager) QueueTx(tx *dashutil.Tx, peer *peerpkg.Peer, done chan struct{}) {
...
// processed.
func (sm *SyncManager) QueueBlock(block *dashutil.Block, peer *peerpkg.Peer, done chan struct{}) {
...
// chain.
func (sm *SyncManager) ProcessBlock(block *dashutil.Block, flags blockchain.BehaviorFlags) (bool, error) {
